...
class BoardingSessionAdmin(admin.ModelAdmin):
    list_display = ['flight', 'status', 'boarding_gate', 'passenger_count', 'passengers_boarded', 'boarding_started_at', 'boarding_completed_at']
...
class BoardingGroupAdmin(admin.ModelAdmin):
    list_display = ['boarding_session', 'group_name', 'called_at', 'passenger_count']
