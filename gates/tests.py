...
class GateAPITest(TestCase):
    def setUp(self):
        ...
        self.gate = Gate.objects.create(gate_number='A1', terminal='A', is_available=True)
        self.airline = Airline.objects.create(name='Test Airline', code='TA')
        self.aircraft = Aircraft.objects.create(registration_number='TC-001', aircraft_type='Boeing 737', capacity=180)
        self.flight = Flight.objects.create(
            flight_number='TA001', origin='JFK', destination='LAX',
