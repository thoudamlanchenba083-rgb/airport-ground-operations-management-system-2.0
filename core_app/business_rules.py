...
from flights.models import Flight, FlightService
...
class BusinessRuleValidator:
    ...
    def can_assign_gate_to_flight(gate, flight):
        ...
        if flight.aircraft.width > gate.width or flight.aircraft.length > gate.length:
            return False, f"Aircraft dimensions exceed gate capacity"
    ...
    def can_assign_equipment_to_flight(equipment, flight):
        ...
        # Rule 2: Equipment conflict detection - same equipment cannot be used by overlapping flights
