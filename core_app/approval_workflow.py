...
class ApprovalRequest(models.Model):
    ...
    # Approval chain
    approval_chain = models.ManyToManyField(
        Staff, through='ApprovalStep', related_name='approvals_pending')
...
class MaintenanceApprovalRequest(models.Model):
    ...
    tech_lead_approved_by = models.ForeignKey(
        Staff,
        on_delete=models.SET_NULL,
        null=True,
        blank=True,
        related_name='tech_approvals')
...
class GateChangeApprovalRequest(models.Model):
    ...
    flight = models.ForeignKey(
        Flight,
        on_delete=models.CASCADE,
        related_name='gate_change_requests')
    ...
    requested_by = models.ForeignKey(
        ...
        on_delete=models.SET_NULL,
        null=True,
        related_name='gate_changes_requested')
    approved_by = models.ForeignKey(
        Staff,
        on_delete=models.SET_NULL,
        null=True,
        blank=True,
        related_name='gate_changes_approved')
...
class FlightDelayApprovalRequest(models.Model):
    ...
    requested_by = models.ForeignKey(
        ...
        on_delete=models.SET_NULL,
        null=True,
        related_name='delays_requested')
    approved_by = models.ForeignKey(
        Staff,
        on_delete=models.SET_NULL,
        null=True,
        blank=True,
        related_name='delays_approved')
    approval_date = models.DateTimeField(null=True, blank=True)
...
class EmergencyFlightApprovalRequest(models.Model):
    ...
    requested_by = models.ForeignKey(
        ...
        on_delete=models.SET_NULL,
        null=True,
        related_name='emergency_flights_requested')
    approved_by = models.ForeignKey(
        Staff,
        on_delete=models.SET_NULL,
        null=True,
        blank=True,
        related_name='emergency_flights_approved')
    approval_date = models.DateTimeField(null=True, blank=True)
