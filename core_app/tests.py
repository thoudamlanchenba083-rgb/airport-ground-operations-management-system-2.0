...
class FlightTests(TestCase):
    ...
    def test_create_flight(self):
        res = self.client.post('/api/flights/', self._flight_payload(), format='json')
        self.assertEqual(res.status_code, status.HTTP_201_CREATED)
    ...
    def test_list_flights(self):
        ...
        res = self.client.get('/api/flights/')
        self.assertEqual(res.status_code, status.HTTP_200_OK)
        self.assertGreaterEqual(res.data['count'], 1)

    def test_create_flight_duplicate_number(self):
        self.client.post('/api/flights/', self._flight_payload(), format='json')
        res = self.client.post('/api/flights/', self._flight_payload(), format='json')
        self.assertEqual(res.status_code, status.HTTP_400_BAD_REQUEST)
    ...
    def test_create_flight_invalid_status(self):
        ...
        res = self.client.post('/api/flights/', payload, format='json')
        self.assertEqual(res.status_code, status.HTTP_400_BAD_REQUEST)

    def test_unauthenticated_cannot_access_flights(self):
        unauth = APIClient()
        res = unauth.get('/api/flights/')
        self.assertEqual(res.status_code, status.HTTP_401_UNAUTHORIZED)
...
class StaffTests(TestCase):
    ...
    def test_create_staff(self):
        res = self.client.post('/api/staff/', self._staff_payload(), format='json')
        self.assertEqual(res.status_code, status.HTTP_201_CREATED)

    def test_duplicate_email_rejected(self):
        self.client.post('/api/staff/', self._staff_payload(), format='json')
        res = self.client.post('/api/staff/', self._staff_payload(employee_id='EMP002'), format='json')
        self.assertEqual(res.status_code, status.HTTP_400_BAD_REQUEST)

    def test_duplicate_employee_id_rejected(self):
        self.client.post('/api/staff/', self._staff_payload(), format='json')
        res = self.client.post('/api/staff/', self._staff_payload(email='other@test.com'), format='json')
        self.assertEqual(res.status_code, status.HTTP_400_BAD_REQUEST)
    ...
    def test_ground_staff_cannot_create_staff(self):
        ...
        res = client.post('/api/staff/', self._staff_payload(), format='json')
...
class EdgeCaseTests(TestCase):
    ...
    def test_invalid_token_rejected(self):
        ...
        res = bad_client.get('/api/flights/')
        self.assertEqual(res.status_code, status.HTTP_401_UNAUTHORIZED)
