...
# elevated/admin access must be granted manually by an existing admin afterward.
SELF_REGISTERABLE_ROLES = [choice[0] for choice in User.ROLE_CHOICES if choice[0] != 'ADMIN']


class RegisterSerializer(serializers.ModelSerializer):
    password = serializers.CharField(write_only=True, min_length=8)
    role = serializers.ChoiceField(choices=SELF_REGISTERABLE_ROLES, default='VIEWER')
