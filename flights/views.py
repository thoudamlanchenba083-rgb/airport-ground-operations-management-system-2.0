...
class AirlineViewSet(viewsets.ModelViewSet):
    ...
    def perform_create(self, serializer):
        ...
        log_action(
            ...
            'Airline',
            instance.id,
            f'Created airline {instance.name}',
            self.request)
    ...
    def perform_update(self, serializer):
        ...
        log_action(
            ...
            'Airline',
            instance.id,
            f'Updated airline {instance.name}',
            self.request)
    ...
    def perform_destroy(self, instance):
        log_action(
            ...
            'Airline',
            instance.id,
            f'Deleted airline {instance.name}',
            self.request)
        instance.delete()
...
class AircraftViewSet(viewsets.ModelViewSet):
    ...
    def perform_create(self, serializer):
        ...
        log_action(
            ...
            'Aircraft',
            instance.id,
            f'Created aircraft {instance.registration_number}',
            self.request)
    ...
    def perform_update(self, serializer):
        ...
        log_action(
            ...
            'Aircraft',
            instance.id,
            f'Updated aircraft {instance.registration_number}',
            self.request)
    ...
    def perform_destroy(self, instance):
        log_action(
            ...
            'Aircraft',
            instance.id,
            f'Deleted aircraft {instance.registration_number}',
            self.request)
        instance.delete()
...
class FlightViewSet(viewsets.ModelViewSet):
    ...
    def perform_create(self, serializer):
        ...
        log_action(
            ...
            'Flight',
            instance.id,
            f'Created flight {instance.flight_number}',
            self.request)
    ...
    def perform_update(self, serializer):
        ...
        log_action(
            ...
            'Flight',
            instance.id,
            f'Updated flight {instance.flight_number}',
            self.request)
    ...
    def perform_destroy(self, instance):
        log_action(
            ...
            'Flight',
            instance.id,
            f'Deleted flight {instance.flight_number}',
            self.request)
        instance.delete()
    ...
    def advance_step(self, request, pk=None):
        ...
        try:
            flight = FlightWorkflowService.advance_step(
                flight, step, notes, request.user)
        ...
        log_action(
            ...
            'Flight',
            flight.id,
            f'Advanced flight {flight.flight_number} to step {step}',
            request)
